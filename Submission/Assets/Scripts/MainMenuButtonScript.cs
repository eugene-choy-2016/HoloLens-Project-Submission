...
public class MainMenuButtonScript : MonoBehaviour, IFocusable, IInputClickHandler, ISpeechHandler
{
    ...
    public void OnInputClicked(InputClickedEventData eventData)
    {
        ...
        DontDestroyOnLoad(GameObject.Find("CursorWithFeedback"));
        DontDestroyOnLoad(GameObject.Find("SpatialMapping"));
        DontDestroyOnLoad(GameObject.Find("SpatialProcesing"));
        DontDestroyOnLoad(GameObject.Find("SurfacePlanes"));
